...
### Fixed
- Force newer NDK version for AAB so it has 16kb page support for google play console. 
...
### Added
- Recordings for phone, tablet (7inch), tablet (10inch) and chrome book for aab packaging. 

### Changed

- The preset row sits above the Hiragana/Katakana tabs since it covers both.
- "Select all" and "Clear" are icon and text buttons again.

## [1.7.1] - 2026-09-04

### Added

- Presets for the character picker. A preset holds the characters picked in both alphabets and is loaded, overwritten or removed from the row beside "Select all" and "Clear".
- Buttons to add, save, remove and restore presets. 

### Changed
- "Select all" and "Clear" now use icon buttons instead of text.
