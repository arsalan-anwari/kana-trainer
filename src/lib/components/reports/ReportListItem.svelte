...
<button
  type="button"
  aria-pressed={picked}
  class="flex w-full cursor-pointer flex-col items-start gap-1 rounded-lg border-2 p-3 text-start transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring {picked
